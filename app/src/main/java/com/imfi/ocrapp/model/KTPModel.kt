...
data class KTPModel(
    ...
    override fun toString(): String {
        return "KTPModel(nik=$nik, nama=$nama, tempatLahir=$tempatLahir, golDarah=$golDarah, tglLahir=$tglLahir, jenisKelamin=$jenisKelamin, alamat=$alamat, rt=$rt, rw=$rw, kelurahan=$kelurahan, kecamatan=$kecamatan, agama=$agama, statusPerkawinan=$statusPerkawinan, pekerjaan=$pekerjaan, kewarganegaraan=$kewarganegaraan, berlakuHingga=$berlakuHingga, provinsi=$provinsi, kabKot=$kabKot, confidence=$confidence)"
    }
